...
<head>
    ...
    <title>Editando Platos</title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css">
</head>
<body>
<div class="container mt-5">
    <h2>Editando Platos</h2>
    ...
    <form action="updatePlatos.php" method="post" class="row g-3">
        <div class="col-12">
        ...
        <div class="col-12">
            ...
            <input type="text" class="form-control" name="PrecioUnitario" id="Precio Unitario" value='<?php echo ($result[0]["Precio Unitario"]); ?>' >
        </div>
        <div class="col-12">
        ...
        <div class="col-12">
            ...
            <input type="text" class="form-control" name="CaloriasUnidad" id="Calorias Unidad" value='<?php echo ($result[0]["Calorias Unidad"]); ?>' >
        </div>
